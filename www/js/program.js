program = new Array();
//Contains all of the saved "programs"
replaying = false;
...
function playStuff(l) {
	...
	if (l != 4) {
		...
		if (l == 3)
			animateBalls(tlayer, this.ballObj1, this.ballObj2);
		anim.start();
	}
}
